...
diabetes_scaler=pickle.load(open("D:/MiniProjects/Disease Predictive System/saved models/diabetes_model.sav",'rb'))
diabetes_model=pickle.load(open("D:/MiniProjects/Disease Predictive System/saved models/diabetes_model.sav",'rb'))

heart_model=pickle.load(open("D:/MiniProjects/Disease Predictive System/saved models/heart_model.sav",'rb'))

breastcancer_model=pickle.load(open("D:/MiniProjects/Disease Predictive System/saved models/breastcancer_model.sav",'rb'))

perkinsons_scaler=pickle.load(open("D:\MiniProjects\Disease Predictive System\saved models\parkinsons_scaler.sav",'rb'))

perkinsons_model=pickle.load(open("D:\MiniProjects\Disease Predictive System\saved models\parkinsons_model.sav",'rb'))
